/*=============================================================================
  bli_dgemm_armsme_2Vx4Vx4_body.h

  The micro-kernel body, included once per prefetch variant by bli_dgemm_armsme_2Vx4Vx4.S.
...
#define UKR_PF_B        SME_PF_OFF
    ...
    .global SYM(bli_dgemm_armsme_2Vx4Vx4)
    .type   SYM(bli_dgemm_armsme_2Vx4Vx4), %function

SYM(bli_dgemm_armsme_2Vx4Vx4):
...
L(main):
    ...
    cmp x10, #.LSME_ES
    b.ne    L(store_za_cm)
    SME_ZA_ROWS 0, d, UKR_NBLK      // ZA -> C, horizontal slices
    b   L(finalize)
L(store_za_cm):
    SME_ZA_COLS 0, d, UKR_NBLK      // ZA -> C, vertical slices
    b   L(finalize)
...
L(finalize):
    ...
    .size   SYM(bli_dgemm_armsme_2Vx4Vx4), .-SYM(bli_dgemm_armsme_2Vx4Vx4)
