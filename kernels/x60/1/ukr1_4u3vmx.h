...
__asm__ (
    ...
    "beq %[counter], zero, ." LABELPREFIX "4u3vmxepilogue%=\n\t"

    "." LABELPREFIX "4u3vmxloop%=:\n\t"
        ...
        "add %[counter], %[counter], -1\n\t"
        "bnez %[counter], ." LABELPREFIX "4u3vmxloop%=\n\t"
    "." LABELPREFIX "4u3vmxepilogue%=:\n\t"
    ...
    "." LABELPREFIX "4u3vmxend%=:\n\t"
    "add %[counter], %[n], 0\n\t" // nleft
    "beq %[counter], zero, ." LABELPREFIX "1u3vmxend%=\n\t"
    "." LABELPREFIX "1u3vmxloop%=:\n\t"
