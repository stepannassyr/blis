...
void bli_sgemmtrsm_l_x60_2vx14(
       dim_t               m,
       dim_t               n,
       dim_t               k,
...
//            "add t0,t0,-1\n\t"
        ...
        "slli %[anext_cstride], %[anext_cstride], " SIZESHIFT "\n\t"   // PACKNR*sizeof(float)
        ...
        ".alphascale%=:\n\t" // TODO: written manually and unoptimized
            ...
            "vlse32.v v29, (%[ptr11]), %[anext_cstride]\n\t"  // c0_1
            "vlse32.v v30, (t1), %[anext_cstride]\n\t"  // c0_2
            "add %[ptr11], %[ptr11], " SIZEBYTES "\n\t"
            "add t1, t1, " SIZEBYTES "\n\t"
            "vlse32.v v31, (%[ptr11]), %[anext_cstride]\n\t"  // c1_1
            "vlse32.v v0, (t1), %[anext_cstride]\n\t"  // c1_2
            "vfmsac.vf v1,  f1, v29\n\t" // c0_1
            "vfmsac.vf v2,  f1, v30\n\t" // c0_2
